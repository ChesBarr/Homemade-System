    ...
    if (empty($emailErr) && empty($passwordErr)) {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                header("Location: ".$rootLocation."/home");
                exit();
            } else {
          ...
          <div class="row g-0">
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST" action="">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-success" onclick="window.location.href='<?= $rootLocation ?>/register'">Create new</button>
                  </div>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4"><?= $_ENV['APP_NAME'] ?></h4>
